...
public class MiniatureResource {
    ...
    public ResponseEntity<Miniature> createMiniature(@Valid @RequestBody Miniature miniature) throws URISyntaxException {
    ...
    public ResponseEntity<Miniature> updateMiniature(
        ...
        @Valid @RequestBody Miniature miniature
    ...
    public ResponseEntity<Miniature> partialUpdateMiniature(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody Miniature miniature
    ) throws URISyntaxException {
