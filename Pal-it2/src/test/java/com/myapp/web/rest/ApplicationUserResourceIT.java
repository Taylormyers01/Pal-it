...
class ApplicationUserResourceIT {
    ...
    public static ApplicationUser createEntity(EntityManager em) {
        ApplicationUser applicationUser = new ApplicationUser().applicationUserName(DEFAULT_APPLICATION_USER_NAME);
    ...
    public static ApplicationUser createUpdatedEntity(EntityManager em) {
        ApplicationUser applicationUser = new ApplicationUser().applicationUserName(UPDATED_APPLICATION_USER_NAME);
        return applicationUser;
    }
    ...
    void createApplicationUser() throws Exception {
        ...
        assertThat(testApplicationUser.getApplicationUserName()).isEqualTo(DEFAULT_APPLICATION_USER_NAME);
    }
    ...
    @Test
    @Transactional
    void checkApplicationUserNameIsRequired() throws Exception {
        int databaseSizeBeforeTest = applicationUserRepository.findAll().size();
        // set the field null
        applicationUser.setApplicationUserName(null);
    ...
    void putExistingApplicationUser() throws Exception {
        ...
        updatedApplicationUser.applicationUserName(UPDATED_APPLICATION_USER_NAME);
        ...
        ApplicationUser testApplicationUser = applicationUserList.get(applicationUserList.size() - 1);
        assertThat(testApplicationUser.getApplicationUserName()).isEqualTo(UPDATED_APPLICATION_USER_NAME);
    }
    ...
    void fullUpdateApplicationUserWithPatch() throws Exception {
        ...
        partialUpdatedApplicationUser.applicationUserName(UPDATED_APPLICATION_USER_NAME);
