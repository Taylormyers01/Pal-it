...
class MiniatureResourceIT {
    ...
    @Test
    @Transactional
    void checkMiniatureNameIsRequired() throws Exception {
        int databaseSizeBeforeTest = miniatureRepository.findAll().size();
        // set the field null
        miniature.setMiniatureName(null);

        // Create the Miniature, which fails.
        ...
        List<Miniature> miniatureList = miniatureRepository.findAll();
        assertThat(miniatureList).hasSize(databaseSizeBeforeTest);
    }
