...
class PaintResourceIT {
    ...
    void checkBrandIsRequired() throws Exception {
        int databaseSizeBeforeTest = paintRepository.findAll().size();
        // set the field null
        paint.setBrand(null);

        // Create the Paint, which fails.
        ...
        List<Paint> paintList = paintRepository.findAll();
        assertThat(paintList).hasSize(databaseSizeBeforeTest);
    }

    @Test
    @Transactional
    void checkPaintNameIsRequired() throws Exception {
        int databaseSizeBeforeTest = paintRepository.findAll().size();
        // set the field null
        paint.setPaintName(null);
