...
public class PaintResource {
     ...
     */
    @PostMapping("/paints")
    public ResponseEntity<Paint> createPaint(@RequestBody Paint paint) throws URISyntaxException {
    ...
    public ResponseEntity<Paint> updatePaint(@PathVariable(value = "id", required = false) final Long id, @RequestBody Paint paint)
    ...
    public ResponseEntity<Paint> partialUpdatePaint(@PathVariable(value = "id", required = false) final Long id, @RequestBody Paint paint)
        throws URISyntaxException {
